...
normal_loss_values = open('/Users/haraldott/Downloads/results/Transfer Sasho Utah/bert_epochs_100_seq_len:_7_anomaly_type:insert_words_1/normal_loss_values', 'r').readlines()
anomaly_loss_values = open('/Users/haraldott/Downloads/results/Transfer Sasho Utah/bert_epochs_100_seq_len:_7_anomaly_type:insert_words_1/anomaly_loss_values', 'r').readlines()
...
per = percentile(normal_loss_values, 97)

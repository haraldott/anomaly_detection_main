...
with open(results_folder + 'gpt2_multiclass_insert_words_results_anomaly_ratio_0.05.txt', 'a') as results:
...
alteration_ratio = 0.05
with open(results_folder + 'gpt2_multiclass_remove_words_results_anomaly_ratio_0.05.txt', 'a') as results:
    while alteration_ratio <= 0.15:
...
alteration_ratio = 0.05
with open(results_folder + 'gpt2_multiclass_replace_words_results_anomaly_ratio_0.05.txt', 'a') as results:
    while alteration_ratio <= 0.15:

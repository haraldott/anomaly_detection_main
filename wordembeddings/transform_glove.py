...
parser.add_argument('-logfile', type=str,
                    default='../data/openstack/utah/parsed/openstack_18k_anomalies_corpus')
parser.add_argument('-vectorsfile', type=str,
                    default='../data/openstack/utah/embeddings/openstack_18k_anomalies_embeddings.txt')
...
vectors_file = open(args.vectorsfile, 'r')
...
pickle.dump(padded_embeddings, open(args.outputfile, 'wb'))

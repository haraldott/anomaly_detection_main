...
with open(results_folder + 'gpt2_regression_reverse_results_anomaly_ratio_0.05.txt', 'a') as results:
...
# experiment(anomaly_type='regression', anomaly_amount=1, mode="regression",
#            prediction_only=False, anomaly_ratio=0.05, alteration_ratio=0.05,

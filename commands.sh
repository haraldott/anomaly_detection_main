...
python transfer_learning.py -finetune -anomaly_type="insert_words" -anomaly_amount= 2
python transfer_learning.py -finetune -anomaly_type="insert_words" -anomaly_amount= 3
python transfer_learning.py -finetune -anomaly_type="insert_words" -anomaly_amount= 4
python transfer_learning.py -finetune -anomaly_type="insert_words" -anomaly_amount= 5
python transfer_learning.py -finetune -anomaly_type="insert_words" -anomaly_amount= 6
python transfer_learning.py -finetune -anomaly_type="remove_words" -anomaly_amount= 1
python transfer_learning.py -finetune -anomaly_type="remove_words" -anomaly_amount= 2
python transfer_learning.py -finetune -anomaly_type="remove_words" -anomaly_amount= 3
python transfer_learning.py -finetune -anomaly_type="duplicate_lines"
python transfer_learning.py -finetune -anomaly_type="delete_lines"
python transfer_learning.py -finetune -anomaly_type="random_lines"
python transfer_learning.py -finetune -anomaly_type="shuffle"
...
python normal_learning.py -finetune -anomaly_type="insert_words" -anomaly_amount=1
python normal_learning.py -finetune -anomaly_type="insert_words" -anomaly_amount=2 -anomaly_only
python normal_learning.py -finetune -anomaly_type="insert_words" -anomaly_amount=3 -anomaly_only
python normal_learning.py -finetune -anomaly_type="insert_words" -anomaly_amount=4 -anomaly_only
python normal_learning.py -finetune -anomaly_type="insert_words" -anomaly_amount=5 -anomaly_only
python normal_learning.py -finetune -anomaly_type="insert_words" -anomaly_amount=6 -anomaly_only
python normal_learning.py -finetune -anomaly_type="insert_words" -anomaly_amount=7 -anomaly_only
python normal_learning.py -finetune -anomaly_type="insert_words" -anomaly_amount=8 -anomaly_only
python normal_learning.py -finetune -anomaly_type="insert_words" -anomaly_amount=9 -anomaly_only
...
python normal_learning.py -finetune -anomaly_type="reverse_order" -anomaly_only
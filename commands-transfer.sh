...
python transfer_learning.py -finetune -anomaly_type="replace_words" -anomaly_amount=1 -anomaly_only
python transfer_learning.py -finetune -anomaly_type="replace_words" -anomaly_amount=2 -anomaly_only
python transfer_learning.py -finetune -anomaly_type="replace_words" -anomaly_amount=3 -anomaly_only
...
python transfer_learning.py -finetune -anomaly_type="no_anomaly" -anomaly_only
python transfer_learning.py -finetune -anomaly_type="reverse_order" -anomaly_only
